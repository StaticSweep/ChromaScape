...
/**
 * Abstract interface for input injection operations across different platforms.
 * This allows platform-specific implementations while maintaining a consistent API.
 */
public interface InputManager {
     ...
     */
    boolean sendKeyEvent(int processId, int eventId, long when, int modifiers, 
     ...
     * @return true if the event was successfully sent, false otherwise
     */
    boolean sendMouseEvent(int processId, int eventId, long when, int modifiers,
